...
dc_leaflet.bubbleChart = function (parent, chartGroup) {
    ...
    var _unselectedColor = '#ff3000';
    var _layerGroup = false;
    var _bombingCircles = {fillOpacity: 0.7, fillRule: 'nonzero'}
    ...
    var _r = d3.scaleLinear().domain([0, 50]);
    var _brushOn = true;
    ...
    var _marker = function (d, map) {
        ...
        var circle = L.circleMarker(latlng,_bombingCircles );
